...
class Router:
    ...
    def parse(self, str=None, ret=None):
        ...
        try:
            ...
            sys.stdout.write("data:text/html,<!DOCTYPE html><html><head><meta charset=\"utf-8\"><meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge,chrome=1\"><title>Temp</title><style>body *{background:#ccc;padding:1px;</style></head><body>%s<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js\"></script></body></html>" % re.sub(r'\n\s*', '', output))
