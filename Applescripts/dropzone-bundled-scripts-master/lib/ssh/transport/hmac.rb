require 'ssh/transport/hmac/md5'
require 'ssh/transport/hmac/md5_96'
require 'ssh/transport/hmac/sha1'
require 'ssh/transport/hmac/sha1_96'
require 'ssh/transport/hmac/none'
